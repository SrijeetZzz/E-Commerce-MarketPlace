        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 space-y-8">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9]">
              Elevating Every <br /> <span className="text-slate-400">Standard.</span>
            </h1>
            <p className="text-lg text-slate-500 max-w-lg font-medium leading-relaxed">
              Wearix was founded on a simple principle: high-end fashion shouldn't be high-barrier. 
              We curate the world's most unique sellers into one seamless experience.
            </p>
          </div>
      ...
      <section className="bg-slate-900 py-24 text-white rounded-t-[60px]">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            ...
            { icon: <ShieldCheck />, title: "Authentic", desc: "Every item is verified by our experts." },
            { icon: <Globe />, title: "Global", desc: "Curated styles from every corner of the world." }
          ].map((val, i) => (
