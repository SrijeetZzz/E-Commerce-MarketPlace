...
import { ArrowRight, Sparkles, Globe, Send, Mail, ArrowUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center pb-20 border-b border-white/5">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-[1.1]">
              Elevate your <br />{" "}
              <span className="text-slate-600 font-medium italic">Inbox.</span>
            </h2>
            <p className="text-slate-500 max-w-sm font-medium leading-relaxed">
              Join 50k+ fashion enthusiasts. No spam, just curated drops and
              seller stories.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 py-20">
          ...
          <div className="col-span-2 md:col-span-1 space-y-10">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="#"
                className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 hover:-translate-y-1 transition-all duration-300"
              >
                <svg
                  width="20"
                  height="20"
          ...
          <div className="space-y-8">
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-600">
              Inventory
            </h4>
