...
//               <button
//                 onClick={() => router.push("/seller")}
//                 className="hidden lg:block bg-purple-600 px-3 py-1.5 rounded-full text-sm hover:bg-purple-700"
//               >
//                 Become Seller
//               </button>
...
//                 <button
//                   onClick={() => setAuthOpen(true)}
//                   className="hidden md:block bg-white text-black px-3 py-1.5 rounded-full text-sm"
//                 >
//                   Sign In
//                 </button>
//               )}
...
//         {/* MOBILE MENU */}
//         {menuOpen && (
//           <div className="md:hidden bg-black border-t border-white/10 px-4 py-6 flex flex-col items-center gap-5">

//             <button onClick={() => { router.push("/"); setMenuOpen(false); }}>Home</button>
//             <button onClick={() => { router.push("/shop"); setMenuOpen(false); }}>Shop</button>
//             <button onClick={() => { router.push("/about"); setMenuOpen(false); }}>About</button>
//             <button onClick={() => { router.push("/blog"); setMenuOpen(false); }}>Blog</button>
