...
interface Props {
  data: DashboardTables["topSellers"];
}
    ...
    <Card className="overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <CardHeader className="border-b border-slate-100 pb-4 dark:border-zinc-800/80">
        ...
        <CardDescription className="text-xs text-slate-500 dark:text-zinc-400">
          Highest earning sellers in the selected period
        </CardDescription>
      </CardHeader>
        ...
        <Table>
          <TableHeader className="bg-slate-50/50 dark:bg-zinc-800/40">
            <TableRow className="border-b border-slate-100 dark:border-zinc-800">
              ...
              <TableHead className="text-xs font-semibold text-slate-700 dark:text-zinc-300">Orders</TableHead>
                ...
                >
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200/60 dark:bg-emerald-950/40 dark:text-emerald-400 dark:ring-emerald-800/50">
